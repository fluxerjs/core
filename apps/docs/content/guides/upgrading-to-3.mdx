...
For bots already on 2.x. New to Fluxer? Start with [Installation](/guides/installation/). Still on 1.x? Finish [Migrating to 2.0](/guides/migration/) first, then return here. Already on 3.0 and moving to 3.1? See [Upgrading to 3.1](/guides/upgrading-to-3-1/).
